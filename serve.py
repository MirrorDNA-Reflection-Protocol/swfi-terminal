...
SOURCE_TAXONOMY = [
    ...
    {
        "family": "Structured official datasets",
        "sources": [
            "Public pension datasets and APIs such as Public Plans Data",
            "SEC structured holdings and adviser datasets such as 13F, IAPD, and municipal advisor files",
            "Tax-exempt and charity registries such as IRS TEOS, Charity Commission, and OSCR",
            "Macro and reserve APIs such as IMF, ECB, and OECD SDMX services",
            "Procurement and contract APIs such as SAM.gov and TED",
        ],
    },
    {
        "family": "Enhancers",
...
REQUIRED_API_STACK = [
    ...
    {
        "name": "Public pension and actuarial datasets",
        "status": "blocked",
        "why": "Public pension allocations, funding ratios, contribution stress, and investment fees are available from underused official or quasi-official public datasets.",
        "gap": "Need recurring pulls, normalization, and entity matching against SWFI profiles.",
        "sources": [
            {"label": "Public Plans Data API", "url": "https://publicplansdata.org/public-plans-database/api/"},
            {"label": "Public Plans Data documentation", "url": "https://publicplansdata.org/public-plans-database/documentation/"},
            {"label": "U.S. Census public pensions survey methodology", "url": "https://www2.census.gov/programs-surveys/aspp/technical-documentation/methodology/2024/2024surveymethodology.pdf"},
        ],
    },
    {
        "name": "Manager registry and holdings disclosure rails",
        "status": "blocked",
        "why": "Manager discovery, gatekeeper mapping, and public portfolio disclosure can be strengthened using official adviser and holdings datasets.",
        "gap": "Need ingestion for 13F data, adviser registries, ADV brochures, and municipal advisor files with entity resolution.",
        "sources": [
            {"label": "SEC Form 13F data sets", "url": "https://www.sec.gov/data-research/sec-markets-data/form-13f-data-sets"},
            {"label": "SEC official Section 13F list", "url": "https://www.sec.gov/rules-regulations/staff-guidance/official-list-section-13f-securities"},
            {"label": "IAPD adviser data", "url": "https://adviserinfo.sec.gov/IAPD/default.aspx"},
            {"label": "SEC municipal advisor data", "url": "https://www.sec.gov/data-research/sec-markets-data/information-about-registered-municipal-advisors"},
        ],
    },
    {
    ...
    {
        "name": "Endowment and charity registry rails",
        "status": "blocked",
        "why": "Endowments, charitable pools, and foundations can be resolved more accurately through official registry data rather than relying on generic web profiles.",
        "gap": "Need charity and nonprofit entity normalization plus bulk registry sync for the relevant jurisdictions.",
        "sources": [
            {"label": "IRS TEOS bulk data", "url": "https://www.irs.gov/charities-non-profits/search-for-tax-exempt-organizations"},
            {"label": "Charity Commission API", "url": "https://register-of-charities.charitycommission.gov.uk/en/documentation-on-the-api"},
            {"label": "OSCR Public APIs", "url": "https://www.oscr.org.uk/about-charities/search-the-register/download-the-scottish-charity-register/oscr-public-apis/"},
        ],
    },
    {
    ...
    {
        "name": "Macro, reserves, and market context APIs",
        "status": "blocked",
        "why": "Sovereign and public-capital decisions are shaped by reserves, fiscal conditions, and macro regimes that can be sourced from official international statistical APIs.",
        "gap": "Need a normalized macro-context layer and country-level alerting rather than one-off manual lookups.",
        "sources": [
            {"label": "IMF Data APIs", "url": "https://data.imf.org/en/Resource-Pages/IMF-API"},
            {"label": "ECB Data Portal API", "url": "https://data.ecb.europa.eu/help/api/data"},
            {"label": "OECD Data API", "url": "https://www.oecd.org/en/data/insights/data-explainers/2024/09/api.html"},
            {"label": "U.S. Treasury Fiscal Data API", "url": "https://fiscaldata.treasury.gov/api-documentation/"},
        ],
    },
    {
        "name": "Government procurement and assistance APIs",
        "status": "blocked",
        "why": "Procurement and award APIs expose mandate-adjacent buying signals, consultant activity, and contract flows that standard allocator datasets miss.",
        "gap": "Need source-specific filters, entity matching, and recurring collection for the public procurement rails that matter to institutional capital.",
        "sources": [
            {"label": "SAM.gov Opportunities Public API", "url": "https://open.gsa.gov/api/get-opportunities-public-api/"},
            {"label": "SAM.gov Contract Awards API", "url": "https://open.gsa.gov/api/contract-awards/"},
            {"label": "Federal Assistance Listings API", "url": "https://sam.gov/announcements/gsa-releases-new-federal-assistance-listings-api"},
            {"label": "TED Search API", "url": "https://docs.ted.europa.eu/api/latest/search.html"},
        ],
    },
    {
...
OFFICIAL_SOURCE_WATCHLIST = [
    ...
    {
        "family": "Structured official datasets",
        "source_name": "Public Plans Data API",
        "collection": "Asset Allocation",
        "focus": "Public pension allocations, funding, contributions, fees, and actuarial history",
        "cadence": "Annual refresh",
        "priority": "High",
        "tone": "watch",
        "why_it_matters": "This is one of the best underused structured sources for public pension behavior and peer comparison in the U.S.",
    ...
    },
    {
        ...
        "focus": "Quarterly holdings disclosures from large institutional investment managers",
        "cadence": "Quarterly",
        "priority": "High",
        "tone": "watch",
        "why_it_matters": "13F datasets are a reliable official rail for public holdings and manager exposure that many institutional intelligence products underuse.",
        "url": "https://www.sec.gov/data-research/sec-markets-data/form-13f-data-sets",
    },
    {
        "family": "Structured official datasets",
        "source_name": "IAPD adviser data",
        "collection": "Profiles",
        "focus": "Investment adviser registry, ADV filings, brochures, and public adviser identity data",
        "cadence": "Ongoing",
        "priority": "High",
        "tone": "watch",
        "why_it_matters": "Official adviser registry data helps map manager platforms, addresses, control entities, and brochure disclosures.",
        "url": "https://adviserinfo.sec.gov/IAPD/default.aspx",
    },
    {
        "family": "Structured official datasets",
        "source_name": "IRS TEOS bulk data",
        "collection": "Profiles",
        "focus": "Tax-exempt organization status, Form 990 rails, and determination-letter context",
        "cadence": "Monthly or periodic posting",
        "priority": "Medium",
        "tone": "partial",
        "why_it_matters": "Useful for foundation, endowment, and nonprofit entity verification where website data is incomplete or stale.",
        "url": "https://www.irs.gov/charities-non-profits/search-for-tax-exempt-organizations",
    },
    {
        "family": "Structured official datasets",
        "source_name": "SEC municipal advisor data",
        "collection": "Mandates",
        "focus": "Registered municipal advisor firms, identifiers, and adviser coverage downloads",
        "cadence": "Monthly",
        "priority": "Medium",
        "tone": "watch",
        "why_it_matters": "This is a niche but valuable rail for pension consultant and municipal advisory relationship mapping.",
        "url": "https://www.sec.gov/data-research/sec-markets-data/information-about-registered-municipal-advisors",
    },
    {
        "family": "Structured official datasets",
        "source_name": "Charity Commission API",
        "collection": "Profiles",
        "focus": "England and Wales charity register search and latest charity information",
        "cadence": "Ongoing",
        "priority": "Medium",
        "tone": "partial",
        "why_it_matters": "Underused official registry for UK endowments, trusts, and charitable pools relevant to allocator mapping.",
        "url": "https://register-of-charities.charitycommission.gov.uk/en/documentation-on-the-api",
    },
    {
        "family": "Structured official datasets",
        "source_name": "OSCR Public APIs",
        "collection": "Profiles",
        "focus": "Scottish charity register and annual returns",
        "cadence": "Ongoing",
        "priority": "Medium",
        "tone": "partial",
        "why_it_matters": "Adds official Scottish charity and annual-return coverage that most allocator products skip.",
    ...
    },
    {
        ...
        "collection": "Asset Allocation",
        "focus": "Reserves, fiscal, external sector, and macro context via SDMX APIs",
        "cadence": "Dataset-dependent",
        "priority": "Medium",
        "tone": "watch",
        "why_it_matters": "Macro and reserve context can explain sovereign capital availability and pressure before fund-level disclosures change.",
        "url": "https://data.imf.org/en/Resource-Pages/IMF-API",
    },
    {
        "family": "Structured official datasets",
        "source_name": "ECB Data Portal API",
        "collection": "Asset Allocation",
        "focus": "Official reserve assets, securities holdings statistics, and euro-area institutional data",
        "cadence": "Dataset-dependent",
        "priority": "Medium",
        "tone": "watch",
        "why_it_matters": "The ECB API exposes official structured datasets that can enrich reserve and securities-holdings context.",
        "url": "https://data.ecb.europa.eu/help/api/data",
    },
    {
        "family": "Mandates and RFPs",
        "source_name": "SAM.gov Opportunities Public API",
        "collection": "RFPs",
        "focus": "Published opportunity details, filters, and active opportunity search",
        "cadence": "Daily",
        "priority": "High",
        "tone": "watch",
        "why_it_matters": "Overlooked official procurement API for U.S. opportunities, including mandates and technology buys adjacent to institutional workflows.",
        "url": "https://open.gsa.gov/api/get-opportunities-public-api/",
    },
    {
        "family": "Mandates and RFPs",
        "source_name": "SAM.gov Contract Awards API",
        "collection": "Mandates",
        "focus": "Contract award and IDV search, extracts, and award-family summaries",
        "cadence": "Ongoing",
        "priority": "Medium",
        "tone": "watch",
        "why_it_matters": "Award records can expose consultant, vendor, and data-buying relationships after opportunities close.",
...
EXTERNAL_API_MATRIX = [
    ...
    {
        "name": "Public Plans Data API",
        "access": "free_public",
        "status": "ok",
        "use_case": "Public pension allocations, funding ratios, contributions, investment returns, and fees.",
        "note": "Official API and downloads for more than 250 major state and local pensions in the U.S., with plan-level history back to 2001 and coverage through 2024.",
        "url": "https://publicplansdata.org/public-plans-database/api/",
    },
    {
        ...
        "access": "free_public",
        "status": "ok",
        "use_case": "Quarterly public holdings and institutional investment manager exposure.",
        "note": "Official SEC structured holdings data, refreshed quarterly; current page spans July 2013 through February 2026.",
        "url": "https://www.sec.gov/data-research/sec-markets-data/form-13f-data-sets",
    },
    {
        "name": "IAPD adviser data",
        "access": "free_public",
        "status": "ok",
        "use_case": "Investment adviser registry, ADV filings, brochures, and manager identity resolution.",
        "note": "Official SEC/FINRA public disclosure rail with downloadable adviser and Form ADV data.",
        "url": "https://adviserinfo.sec.gov/IAPD/default.aspx",
    },
    {
        ...
        "access": "free_public",
        "status": "ok",
        "use_case": "Endowment, nonprofit, and foundation verification through tax-exempt status and filing rails.",
        "note": "Official IRS search and bulk-download surface for Form 990, Pub. 78, auto-revocation, and determination letters.",
        "url": "https://www.irs.gov/charities-non-profits/search-for-tax-exempt-organizations",
    },
    {
        "name": "SEC municipal advisor data",
        "access": "free_public",
        "status": "ok",
        "use_case": "Municipal advisor registry and consultant relationship mapping for pension and public-finance workflows.",
        "note": "Official SEC monthly XLSX downloads of registered municipal advisor firms and identifiers; current page spans March 2015 through April 2026.",
        "url": "https://www.sec.gov/data-research/sec-markets-data/information-about-registered-municipal-advisors",
    },
    {
        "name": "Charity Commission API",
        "access": "free_public_with_key",
        "status": "ok",
        "use_case": "England and Wales charity registry search and current charity data for foundation/endowment resolution.",
        "note": "Official beta API requiring developer-hub registration and an API key.",
        "url": "https://register-of-charities.charitycommission.gov.uk/en/documentation-on-the-api",
    },
    {
        "name": "OSCR Public APIs",
        "access": "free_public_with_key",
        "status": "ok",
        "use_case": "Scottish charity register and annual-return lookup.",
        "note": "Official beta API with request-based access and x-functions-key authentication.",
        "url": "https://www.oscr.org.uk/about-charities/search-the-register/download-the-scottish-charity-register/oscr-public-apis/",
    },
    {
        "name": "IMF Data APIs",
        "access": "free_public",
        "status": "ok",
        "use_case": "Country-level reserves, fiscal, balance-of-payments, and macro context via SDMX.",
        "note": "Official IMF SDMX 2.1 and 3.0 data APIs; swagger access uses the IMF portal sign-in, but dataset access is part of the official data API program.",
        "url": "https://data.imf.org/en/Resource-Pages/IMF-API",
    },
    {
        ...
        "access": "free_public",
        "status": "ok",
        "use_case": "Official reserve assets, securities holdings statistics, and other ECB statistical data.",
        "note": "Official ECB SDMX API at data-api.ecb.europa.eu; current portal notes the old SDW redirects ended after October 1, 2025.",
        "url": "https://data.ecb.europa.eu/help/api/data",
    },
    {
        "name": "OECD Data API",
        "access": "free_public",
        "status": "ok",
        "use_case": "Global pension statistics, macro comparisons, and contextual benchmarking via SDMX.",
        "note": "Official OECD API guidance updated April 30, 2025; rate limits apply.",
    ...
    },
    {
        ...
        "access": "free_public_with_key",
        "status": "ok",
        "use_case": "Published opportunity details and mandate-adjacent procurement search.",
        "note": "Official GSA API with public API key requirement; v2 endpoint supports pagination and daily-updated active notices.",
        "url": "https://open.gsa.gov/api/get-opportunities-public-api/",
    },
    {
        ...
        "access": "free_public_with_key",
        "status": "ok",
        "use_case": "Contract award search, extracts, award-family rollups, and post-award relationship mapping.",
        "note": "Official GSA API with JSON/CSV extracts and rate limits based on SAM.gov user or system account type.",
        "url": "https://open.gsa.gov/api/contract-awards/",
    },
    {
        "name": "NewsAPI",
